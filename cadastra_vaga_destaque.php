...
check_plano_recrutador();//somente quem tem plano recrutador pode acessar essa página!
...
$display_main->conteudo('<h1>Cadastre sua Vaga Destaque</h1>
<p>A Vaga Destaque do Plano Recrutador é uma ótima opção para quem precisa de resultados rápidos no que se refere à captação de currículos.
Preencha o formulário abaixo para cadastrá-la  em nosso sistema.
 Lembre-se que <strong>os currículos serão enviados para o e-mail informado abaixo!</strong></p>

			
			<form action="cadastra_vaga_destaque.php" enctype="multipart/form-data" method="post">

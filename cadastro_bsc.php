...
<title>Cadastro BSC em Rede</title>
...
<body>
<h1>Pré-inscrição no curso Planejamento Estratégico na Área da Saúde</h1>
...
if(isset($_POST['input_nome']))//Se usuário está tentando cadastrar
	{
		...
		$qry = "INSERT INTO leads_bsc VALUES (null,?,?,?)";
...
<form action="cadastro_bsc.php" method="post">

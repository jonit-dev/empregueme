...
$db['testes']['password'] = '';
$db['testes']['database'] = 'empre941_empregueme';
...
$db['producao']['username'] = 'empre941_user';
$db['producao']['password'] = 'Empre#12';
$db['producao']['database'] = 'empre941_rede';
$db['producao']['dbdriver'] = 'mysql';
$db['producao']['dbprefix'] = '';
$db['producao']['pconnect'] = TRUE;
$db['producao']['db_debug'] = FALSE;

...
<div id="empresas_anunciantes">
    ...
    <div class="item_anunciante">
        <center>
            <a href="http://gazetaonline.globo.com/_conteudo/2013/05/oportunidades/vagas/1435090-saiba-como-conseguir-emprego-usando-as-redes-sociais.html"
               target="_blank">
    ...
    <div class="item_anunciante">
        <center>
            <a href="http://m.folhavitoria.com.br/economia/noticia/2014/05/rede-social-profissional-voltada-para-empregos-ja-tem-mais-de-132-mil-usuarios-no-es.html"
               target="_blank">
    ...
    <div class="item_anunciante">
        <a href="http://site.faesa.br/noticia-lendo.aspx?id=689&titulo=Aluno+de+Computa%C3%A7%C3%A3o+cria+aplicativo+para+busca+de+emprego+no+facebook"
           target="_blank">
...
<a href="javascript:void(0)" target="_self">
    <div id="beneficios_bolas">
        <div class="item_beneficio">
            ...
            <div class="beneficio_txt">
                <center>OPORTUNIDADES EXCLUSIVAS
                    <center>
            </div>
        </div>
        ...
        <div class="item_beneficio">
            ...
            <div class="beneficio_txt" style="top:97px;">
                <center>SEJA ENCONTRADO POR EMPRESAS</center>
            </div>
        </div>

        <div class="item_beneficio">
            <img src="gfx/index/curriculo.png" class="img_beneficio" alt="busca_cv"/>
            <div class="beneficio_txt" style="top:90px;">
                <center>ACELERE SUA RECOLOCAÇÃO NO MERCADO</center>
            </div>
        </div>
...
$form_action = 'new_user.php';

if (isset($_GET['vaga_id'])) {
    $form_action = 'new_user.php?vaga_id=' . $_GET['vaga_id'];
}
...
echo '<div id="box_cadastro">
    ...
    <form action="' . $form_action . '"  method="post" id="form_create_account">
...
<li><input type="text" name="nickname" id="nickname" maxlength="8" class="input_create_account" placeholder="Seu apelido ( 8 letras )" />
 ...
 <li><input type="email" name="email" maxlength="60" class="input_create_account" placeholder="Seu e-mail" />
 		<div class="alert">Você esqueceu de preencher seu e-mail.</div>
 </li>

<li><input type="email" autocomplete="off" name="email2" maxlength="60" class="input_create_account" placeholder="Insira seu e-mail novamente" />		<div class="alert">Você esqueceu de preencher seu e-mail.</div></li>
...
<div id="box_content_all"><!--INIT BOX CONTENT ALL-->
    ...
    <div class="box_content" style="margin-top:150px;">

        <div class="box_detail"></div>

        <div class="box_content_title" style="margin-left:-40px;" id="produto_target">Porque Você Deve Ser Membro
            Empregue-me?
        </div>

        <div class="box_content_subtitle" style="margin-left:150px;">Você merece ter acesso a melhores chances de ser
            empregado!
        </div>


        <div class="box_content_txt">
            Sabemos que as coisas não vão muito bem e entendemos as suas preocupações quanto ao futuro: A sensação de
            incerteza e a angústia de ter de ficar nessa situação - correndo até mesmo o risco de passar necessidades
            por não poder pagar suas próprias contas - assombra qualquer um.

            Mas fique calmo! O Empregue-me possui a missão de não apenas melhorar, mas de mudar sua vida para melhor:
            Com a nossa ajuda você terá dinheiro para pagar por seus estudos, construir sua casa própria e ajudar sua
            família a ter muita dignidade.

            <b>Para isso, criamos este site que tem como objetivo principal te levar de encontro ao que você mais quer:
                Um emprego.</b></div>
        <br/>
        ...
        <div class="beneficio_box">
            ...
            <div class="beneficio_item">
                ...
                <img src="gfx/plano_recrutador_novo/economize.png" alt="economize" width="53" height="50"
                     class="beneficio_box_img"/>

                <div class="beneficio_box_title">CADASTRO GRATUITO</div>
                <div class="beneficio_box_subtitle">O cadastro em nossa rede social é totalmente gratuito. Anuncie seu
                    currículo e candidate-se a milhares de vagas.
                </div>
            ...
            <div class="beneficio_item">
                ...
                <img src="gfx/plano_recrutador_novo/favoritos.png" width="53" height="50" alt="favoritos"
                     class="beneficio_box_img"/>

                <div class="beneficio_box_title">OPORTUNIDADES EXCLUSIVAS</div>
                <div class="beneficio_box_subtitle">Milhares de empresas divulgam vagas exclusivamente em nosso sistema.
                    Portanto, fique de olho diariamente!
                </div>
            ...
            <div class="beneficio_item">
                ...
                <img src="gfx/plano_recrutador_novo/clock.png" alt="rapidez" width="53" height="50"
                     class="beneficio_box_img"/>

                <div class="beneficio_box_title">PARE DE PERDER TEMPO</div>
                <div class="beneficio_box_subtitle">Em um só lugar você terá acesso a tudo que precisa para conseguir
                    seu emprego!
                </div>
            ...
            <div class="beneficio_item">
                ...
                <img src="gfx/plano_recrutador_novo/facilidade.png" alt="rapidez" width="53" height="50"
                     class="beneficio_box_img"/>

                <div class="beneficio_box_title">FACILIDADE E PRATICIDADE</div>
                <div class="beneficio_box_subtitle">Nosso site foi desenvolvido para que você não tenha "dor de cabeça"
                    ao procurar emprego. É fácil e extremamente eficaz.
                </div>
        ...
        <div class="cta">
            ...
            <div class="btm_cta_cadastre">
                <a href="javascript:void(0);"><img src="gfx/plano_recrutador_novo/btm_cta_cadastrese.png"
                                                   alt="botao cadastrar" class="btm_cadastrar"/></a>
            </div>
        </div>

        <div id="fb_pos">

            <div class="fb-facepile" data-href="https://www.facebook.com/empreguemeoficial" data-width="320"
                 data-height="10" data-max-rows="1" data-colorscheme="light" data-size="medium"
        ...
        <div class="box_content">
            ...
            <div class="box_content_subtitle">Veja algumas de milhares de empresas e candidatos que estão se
                beneficiando com nosso sistema.
            </div>
            ...
            <div class="beneficio_box">
                ...
                <div class="anunciantes">
                    ...
                    <div class="benef_empresa_box">
                        <img src="gfx/plano_recrutador_novo/empresas/yanping.png" alt="yanping" width="102"
                             height="74"/>
                    </div>
                    ...
                    <div class="benef_empresa_box">
                        <img src="gfx/plano_recrutador_novo/empresas/99taxis.png" alt="99taxis" width="102"
                             height="74"/>
                    </div>
                    ...
                    <div class="benef_empresa_box">
                        <img src="gfx/plano_recrutador_novo/empresas/splendido.png" alt="splendido" width="102"
                             height="74"/>
                    </div>
                ...
                <div class="depoimentos">
                    ...
                    <div class="depoimento_item">
                        ...
                        <div class="depoimento_txt">Estou aqui para compartilhar a minha conquista. Depois de vários
                            currículos enviados acabo de ser selecionada para fazer parte da equipe de uma loja de venda
                            de óculos! Obrigado Empregue-me!
                        </div>
                    </div>
                    ...
                    <div class="depoimento_item">
                        ...
                        <div class="depoimento_txt">Queria agradecer aos administradores pela eficácia da página. Enviei
                            o currículo do meu noivo para algumas vagas na segunda à noite e na terça pela manhã já
                            ligaram marcando entrevista!! Funciona mesmo!!
                        </div>
                    </div>
                    ...
                    <div class="barra_resumo_benef">
                        <div class="item_resumo_benef">
                            ...
                            <div class="item_resumo_txt" style="margin-top:110px;">Acelere sua recolocação no mercado
                            </div>
                        </div>
            ...
            <div class="cta">
                ...
                <div class="btm_cta_cadastre">
                    ...
                    <a href="javascript:void(0)" class="><img src=" gfx/plano_recrutador_novo/btm_cta_cadastrese.png"
                    alt="botao cadastrar" class="btm_cadastrar" /></a>
                </div>
            </div>
            ...
            <div class="box_content">
                ...
                <div class="box_content_subtitle" style="margin-left:100px;">Compare e veja porque somos sua melhor
                    opção em vantagens e benefícios.
                </div>

...
<div id="txt_principal">
	Contrate Talentos<span class="txt_bold"> Agora Mesmo!</span>
...
<div id="txt_subprincipal">
	Está precisando correr contra o tempo para contratar os melhores talentos para sua empresa ou evento? <span class="txt_bold">Nós podemos lhe ajudar</span>!
</div>
';
?>
...
if(isset($_GET['aviso']))
{
	switch($_GET['aviso'])
		{
			case 'crie_sua_conta':
			//mostra aviso dizendo que é para criar sua conta
			$display_main->noty('Para acessar os currículos você deve criar sua conta GRATUITA no formulário apontado pela seta!','warning','topCenter',6000);

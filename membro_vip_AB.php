...
k='67548758-5',d=document,l=d.location,c=d.cookie;
...
<!-- FINAL FORMULARIO BOTAO PAGSEGURO -->
    ...
    <a href="membro_vip_pag.php" target="_self">
    	<img  src="gfx/plano_recrutador_novo/planos/vip_semestral.png" style="margin-bottom:10px;margin-left:10px;" alt="plano vip semestral" />
        </a>
    </div>

...
if(isset($_SESSION['login']))
{
$mostra_comprar = '<a href="anuncio.php?id='.$r_produto_id.'&&comprar=true">
...
<a href="index.php" >
		<img src="gfx/ui/btm_preco.png" id="anuncio_btm_comprar" />
			...
			$(document).ready(function(e) { 
					...
					$("#anuncio_btm_comprar").click(function(c){
...
//se não é o usuário tentando comprar o próprio produto, vamos prosseguir
		...
		if(isset($_SESSION['login']))
		{
		$mostra_botoes_compra = '<input type="hidden" name="comprador_email" value="'.$comprador_email.'"/>
